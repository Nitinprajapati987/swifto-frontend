...
const allRoutes = [
  { from: 'Indore', to: 'Mumbai', km: 580, price: '₹45-65k', time: '10-12 hrs' },
  { from: 'Indore', to: 'Delhi', km: 780, price: '₹55-80k', time: '14-16 hrs' },
  { from: 'Indore', to: 'Pune', km: 590, price: '₹45-65k', time: '11-13 hrs' },
  { from: 'Indore', to: 'Ahmedabad', km: 400, price: '₹30-45k', time: '7-8 hrs' },
  { from: 'Indore', to: 'Nagpur', km: 480, price: '₹35-50k', time: '9-10 hrs' },
  { from: 'Indore', to: 'Jaipur', km: 490, price: '₹35-50k', time: '9-10 hrs' },
  { from: 'Indore', to: 'Hyderabad', km: 780, price: '₹60-85k', time: '14-16 hrs' },
  { from: 'Indore', to: 'Chennai', km: 1200, price: '₹90-120k', time: '22-24 hrs' },
  { from: 'Indore', to: 'Kolkata', km: 1400, price: '₹100-130k', time: '26-28 hrs' },
  { from: 'Indore', to: 'Surat', km: 490, price: '₹35-50k', time: '9-10 hrs' },
  { from: 'Indore', to: 'Bangalore', km: 1100, price: '₹80-110k', time: '20-22 hrs' },
  { from: 'Indore', to: 'Bhopal', km: 190, price: '₹15-25k', time: '3-4 hrs' },
];
    ...
    <div id="routes" style={{ background: 'white', padding: '5rem 5%' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '1rem', marginBottom: '1.5rem' }}>Pan India coverage — Pithampur se pura Bharat!</p>
          ...
          <br />
          <input type="text" placeholder="🔍 City ya route search karo..." value={search} onChange={e => setSearch(e.target.value)}
        ...
        {activeTab === 'popular' ? (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem' }}>
            ...
            {filteredRoutes.length === 0 && <p style={{ gridColumn: '1/-1', textAlign: 'center', color: '#6b7280', padding: '2rem' }}>Koi route nahi mila 🔍</p>}
          </div>
        ) : (
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.75rem' }}>
            ...
            {filteredCities.length === 0 && <p style={{ color: '#6b7280', marginTop: '1.5rem' }}>Koi city nahi mili 🔍</p>}
          </div>
        )}

        <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
          <p style={{ fontSize: '0.85rem', color: '#6b7280' }}>
            Apna city nahi dikh raha? <span style={{ color: '#4361ee', cursor: 'pointer', fontWeight: 700 }}>Humse contact karo</span> — hum deliver kar denge!
          </p>
        </div>

      </div>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@700;800;900&family=DM+Sans:wght@400;500;600&display=swap'); input::placeholder { color: #9ca3af; }`}</style>
    </div>
  );
}
