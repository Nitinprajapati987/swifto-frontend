    ...
    <footer id="contact" className="bg-black text-gray-400 pt-14 pb-6 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              India ka pehla AI-powered Hindi Voice B2B Logistics Platform.
              Pithampur, Indore se Pan India delivery.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:+919876543210" className="hover:text-yellow-400 transition flex items-center gap-2">
                  📞 +91 98765 43210
                </a>
              </li>
              <li>
              ...
              <li className="flex items-start gap-2">
                <span>📍</span>
                <span>Pithampur Industrial Zone, Indore, MP</span>
              </li>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600">
          ...
          <p>Made with ❤️ in Indore, India 🇮🇳</p>
        </div>
